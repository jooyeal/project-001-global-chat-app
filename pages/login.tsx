...
const login = (props: Props) => {
    ...
    const loginBtn = async() => {
        const A = await axios.post('http://localhost:8000/api/auth/signin',{
            email: email,
            password: pw
        })
        console.log(A);
            ...
            <div className={styles.titleText}>
                <div className={styles.loginBox}>
                    ...
                    <div className={styles.compLabel}>
                        ...
                        <input className={styles.textBox} type="text" value={email} onChange={onChangeEmail} />
                    </div>
                    <div className={styles.compLabel}>
                        <div className={styles.labelText}>pw</div>
                        {/* <TextField type ="password" value={pw} onChange={onChangepw}/> */}
                        <input className={styles.textBox} type="password" value={pw} onChange={onChangepw} />
                    </div>
